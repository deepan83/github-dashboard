...
import RelationshipField from 'github-dashboard/graphql-adapter/types/field';
...
class Parser {
  ...
  _buildSyncRelationship(store, relName, {kind, type, options}) {
    ...
    let field = new RelationshipField(
      normalizedType,
      aliasedNameOrNull,
      new Type.ArgumentSet(options.arguments),
